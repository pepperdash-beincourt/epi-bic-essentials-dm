...
| Language | C# |
| Declaration | `enum eDmpsLevelType` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`eDmpsLevelType` is a finite set of symbolic states or options used by the surrounding implementation. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

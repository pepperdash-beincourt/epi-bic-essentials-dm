...
| Source file | [`src/Config/InputPropertiesConfig.cs`](../../../src/Config/InputPropertiesConfig.cs) |
| Language | C# |
| Declaration | `class InputPropertiesConfig` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM.Config` |

## What

`InputPropertiesConfig` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

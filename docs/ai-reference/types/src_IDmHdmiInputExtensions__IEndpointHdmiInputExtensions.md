...
| Source file | [`src/IDmHdmiInputExtensions.cs`](../../../src/IDmHdmiInputExtensions.cs) |
| Language | C# |
| Declaration | `class IEndpointHdmiInputExtensions` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`IEndpointHdmiInputExtensions` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `GetVideoStatusFuncsWrapper`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.

...
| Language | C# |
| Declaration | `class DmDge200CControllerFactory` with declared base/contract list `EssentialsPluginDeviceFactory<DmDge200CController>` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM.Endpoints.DGEs` |

## What

`DmDge200CControllerFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

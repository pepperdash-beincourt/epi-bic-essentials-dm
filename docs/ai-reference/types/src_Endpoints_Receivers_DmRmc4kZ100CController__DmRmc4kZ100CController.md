...
| Source file | [`src/Endpoints/Receivers/DmRmc4kZ100CController.cs`](../../../src/Endpoints/Receivers/DmRmc4kZ100CController.cs) |
| Language | C# |
| Declaration | `class DmRmc4kZ100CController` with declared base/contract list `DmRmcX100CController` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`DmRmc4kZ100CController` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Preserve the declared inheritance/contract relationship: `DmRmcX100CController`. Public methods declared in this source file include: `LinkToApi`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.

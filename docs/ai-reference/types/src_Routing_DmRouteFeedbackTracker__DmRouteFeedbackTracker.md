...
| Source file | [`src/Routing/DmRouteFeedbackTracker.cs`](../../../src/Routing/DmRouteFeedbackTracker.cs) |
| Language | C# |
| Declaration | `class DmRouteFeedbackTracker` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM.Routing` |

## What

`DmRouteFeedbackTracker` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Public methods declared in this source file include: `ApplyRoute`, `Clear`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.

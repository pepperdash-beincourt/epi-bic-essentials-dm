...
| Source file | [`src/Endpoints/Transmitters/DmTx4kz302CController.cs`](../../../src/Endpoints/Transmitters/DmTx4kz302CController.cs) |
| Language | C# |
| Declaration | `class DmTx4kz302CController` with declared base/contract list `DmTxControllerBase, ITxRoutingWithFeedback,` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`DmTx4kz302CController` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

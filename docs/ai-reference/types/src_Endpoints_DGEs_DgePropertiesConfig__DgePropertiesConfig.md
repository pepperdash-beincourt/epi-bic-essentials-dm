...
| Source file | [`src/Endpoints/DGEs/DgePropertiesConfig.cs`](../../../src/Endpoints/DGEs/DgePropertiesConfig.cs) |
| Language | C# |
| Declaration | `class DgePropertiesConfig` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM.Endpoints.DGEs` |

## What

`DgePropertiesConfig` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

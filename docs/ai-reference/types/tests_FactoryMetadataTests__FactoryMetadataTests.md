...
Public methods declared in this source file include: `All_Factory_Sources_Set_MinimumEssentialsFrameworkVersion_To_3`, `All_Factory_Sources_Set_TypeNames`, `Factory_Source_Contains_TypeName`, `No_Duplicate_TypeNames_Across_Factory_Sources`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.

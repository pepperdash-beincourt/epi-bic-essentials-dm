...
| Source file | [`src/Config/DmTxConfig.cs`](../../../src/Config/DmTxConfig.cs) |
| Language | C# |
| Declaration | `class DmTxPropertiesConfig` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM.Config` |

## What

`DmTxPropertiesConfig` is a configuration or data-transfer shape used to deserialize and validate structured input. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

...
| Language | C# |
| Declaration | `class DmRmcControllerFactory` with declared base/contract list `EssentialsPluginDeviceFactory<DmRmcControllerBase>` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`DmRmcControllerFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

...
| Language | C# |
| Declaration | `class HdMdxxxCEControllerFactory` with declared base/contract list `EssentialsPluginDeviceFactory<HdMdxxxCEController>` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`HdMdxxxCEControllerFactory` is a construction boundary that maps configuration or discovery inputs into concrete objects. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

# AdvEndpointHdmiOutputExtensions
...
| Language | C# |
| Declaration | `class AdvEndpointHdmiOutputExtensions` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`AdvEndpointHdmiOutputExtensions` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

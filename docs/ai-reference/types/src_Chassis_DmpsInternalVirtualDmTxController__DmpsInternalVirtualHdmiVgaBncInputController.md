# DmpsInternalVirtualHdmiVgaBncInputController
...
| Language | C# |
| Declaration | `class DmpsInternalVirtualHdmiVgaBncInputController` with declared base/contract list `DmpsInternalVirtualHdmiVgaInputController` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`DmpsInternalVirtualHdmiVgaBncInputController` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.

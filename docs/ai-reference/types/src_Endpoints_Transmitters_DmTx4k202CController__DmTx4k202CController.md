...
| Source file | [`src/Endpoints/Transmitters/DmTx4k202CController.cs`](../../../src/Endpoints/Transmitters/DmTx4k202CController.cs) |
| Language | C# |
| Declaration | `class DmTx4k202CController` with declared base/contract list `DmTxControllerBase, ITxRoutingWithFeedback, IHasFeedback,` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.DM` |

## What

`DmTx4k202CController` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
...
Before proposing a change, read this declaration, its full source file, all repository references to `DmTx4k202CController`, and its test coverage. Do not invent configuration keys, payload fields, interface members, or lifecycle ordering. Report the affected source files, tests, and consumer boundaries with any proposed change.
